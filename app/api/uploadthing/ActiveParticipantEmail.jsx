...
export const ActiveParticipantEmail = ({
  studentName,
  studentEmail,
  studentNumber,
  delegateId,
  ...
  const registrationFee =
    isKmcStudent === "true" ? "400" : isPgStudent ? "600" : "600";
  const eventsString = events?.reduce((sum, el) => sum + ", " + el) || "";
  ...
  <head>
    ...
    <title>Active Participant Registration</title>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align"
                                ...
                                <p style="font-size: 14px; line-height: 170%; text-align: left;"><strong>Registration
                                    Fee: </strong>₹${registrationFee}</p>
                                <p style="font-size: 14px; line-height: 170%; text-align: left;"><strong>Payment
                                    Screenshot Link: </strong>${fileUrl}</p>
                                <p style="font-size: 14px; line-height: 170%; text-align: left;"></p>
                                <p style="font-size: 14px; line-height: 170%; text-align: left;"> <strong> Events Participated in:</strong> ${eventsString} </p>
