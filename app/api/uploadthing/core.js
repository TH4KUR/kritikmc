...
import { UploadRegistrationDataAmboss } from "@/app/lib/UploadRegistrationDataAmboss";
      ...
      try {
        ...
        if (metadata.regData?.passiveDelegate) {
          ...
          const email = await resend.emails.send({
            ...
            to: `${studentEmail}`,
            subject:
              "🎉 Thanks for Registering as a Passive Delegate for Kriti!",
            html: `<!DOCTYPE HTML
        ...
        } else if (metadata.regData?.ambossWorkshop) {
          let counterRes = await counter.up("kritikmc", "ambossWorkshop");
          if (counterRes.Count <= 500) {
            await counter.set("kritikmc", "ambossWorkshop", 500);
            counterRes = await counter.up("kritikmc", "ambossWorkshop");
          }
          const delegateId = `KAMB-${String(counterRes.Count).padStart(4, "0")}`;
          metadata.regData.delegateId = delegateId;
          console.log("Uploaded File:  ", file);
          /////////////////////////////////////////////////////
          // Send an email to user
          /////////////////////////////////////////////////////
          const dataUploaded = await UploadRegistrationDataAmboss(
            metadata.regData,
            file.url
          );
          const {
          ...
          const email = await resend.emails.send({
            ...
            to: `${studentEmail}`,
            subject:
              "🎉 Thanks for Registering for AMBOSS Workshop by KMC Warangal!",
            html: `<!DOCTYPE HTML
            PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
          <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
            xmlns:o="urn:schemas-microsoft-com:office:office">
                                      ...
                                      <td class="v-container-padding-padding"
                                        ...
                                        <div class="v-text-align"
                                          ...
                                          <p style="font-size: 14px; line-height: 140%;">Kakatiya Medical College - South North V
                                            P Road, Nizampura, Rangampet Street, Warangal 506007, Telangana, India</p>
                                            <br/>
                                            <p style="text-align:center;"> made with ❤️ by <a href="https://portfolio-eashaan.vercel.app">Eashaan -> </a> </p>
                                        </div>
