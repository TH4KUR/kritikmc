  ...
  if (type === "guest") {
    return (
      <div className="grid grid-cols-12 mt-8">
        ...
        <div className=" bg-[#F1F5DA] col-span-8 rounded-r-lg px-3 py-3">
          ...
          <h4 className=" text-xs text-[#327D18] font-bold">Guest Speaker</h4>
          <p className="mt-3 text-[0.77rem] leading-4 font-medium">
    ...
    /> */}
        ...
        <div className=" bg-[#F4E3D4] col-span-8 rounded-r-lg px-3 py-3">
          <h3 className="font-bold text-lg">Dr. Vikram Subramaniam</h3>
          <h4 className=" text-xs text-red-800 font-bold">Chief Guest</h4>
          <p className="mt-3 text-[0.77rem] leading-4 font-medium">
