  ...
  if (!light) {
    return (
      <section className="bg-[url('/timelinebg.png')] bg-contains bg-origin-border flex flex-col items-center py-20 px-1 text-gray-200">
        ...
        <h3 className="text-gray-200 text-2xl font-semibold md:text-3xl">
          Events Timing Breakdown
        </h3>
        <div className="flex flex-col gap-4 w-11/12 mx-auto max-w-3xl mt-10 text-gray-300">
          <div className="flex justify-between mx-auto w-3/4 text-sm md:text-base font-medium">
            <p>Registration Open</p>
            <span className="before:content-[''] before:absolute  before:w-[50px] md:before:w-[100px] before:h-[1px] before:bg-gray-100 relative flex items-center justify-center "></span>
            <p>27 July 20xx</p>
          </div>
          <div className="flex justify-between mx-auto w-3/4 text-sm md:text-base font-medium">
